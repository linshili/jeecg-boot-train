...
public interface CommonSendStatus {
	...
	public static final String UNPUBLISHED_STATUS_0 = "0";	//未发布 驳回
	
	public static final String PUBLISHED_STATUS_1 = "1";		//已发布
	
	public static final String REVOKE_STATUS_2 = "2";			//撤销

	public static final String CHECKPASS_STATUS_3 = "3";          //审核通过

	public static final Integer UNChECK_STATUS_0 = 0; //未审批过

	public static final Integer ChECKED_STATUS_1 = 1; ////已审批过
